...
graph_data<- data_subset[,c("Date_Time","Global_active_power")]
graph_data$Global_active_power <- graph_data$Global_active_power/1000

#plot to png device
png(filename="plot2.png",width = 504,height = 504,units ="px", bg="white")
plot(graph_data,pch =".",type ="l",ylab="Global Active Power(kilowatts)", xlab="" )
dev.off()

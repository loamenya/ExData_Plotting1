...
graph_data1<- data_subset[,c("Date_Time","Sub_metering_1")]
graph_data2<- data_subset[,c("Date_Time","Sub_metering_2")]
graph_data3<- data_subset[,c("Date_Time","Sub_metering_3")]


#plot to png device
png(filename="plot3.png",width = 504,height = 504,units ="px", bg="white")
plot(graph_data1,pch =".",type ="l",ylab="Energy sub metering", xlab="" )
lines(graph_data2,pch =".",type ="l",col="red")
lines(graph_data3,pch =".",type ="l",col="blue")
